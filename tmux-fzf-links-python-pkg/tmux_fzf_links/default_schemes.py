...
file_scheme:SchemeEntry = {
        ...
        "regex": [
            re.compile(r"(?P<link>^\~?[a-zA-Z0-9_\u00C0-\u017F\/\-\. ]+$)(\:(?P<line>\d+))?",re.MULTILINE), # filename with spaces, starting at the line beginning
            re.compile(r"(?P<link>\~?[a-zA-Z0-9_\u00C0-\u017F\/\-\.]+)(\:(?P<line>\d+))?",re.MULTILINE), # filename not including spaces
            re.compile(r"\'(?P<link>\~?[a-zA-Z0-9_\u00C0-\u017F\/\-\. ]+)\'(\:(?P<line>\d+))?",re.MULTILINE), # filename with spaces, quoted
